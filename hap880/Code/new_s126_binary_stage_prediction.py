...
df_icd9_related_ckd = csv_df('yw_icd_most_freq.csv').head(50)
df_icd9_related_ckd_5854 = csv_df(icd9_related_ckd_5854).head(50)
...
if no_ccs == 1:
	list_icd_ccs = list_icd9_related_ckd + ['naccs'] + list_hcpcs_most_freq
else:
