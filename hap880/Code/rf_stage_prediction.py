...
logging.basicConfig(filename='prediction_rf.log', filemode='w', format='%(name)s - %(levelname)s - %(message)s')
...
pid_diags_dict = 'yw_pid_diags_dict.csv'
...
dict_pid_diag = {(x,y):z for [x, y, z] in df_pid_diags_dict[['dsysrtky', 'diag', 'min']].values.tolist()} 
